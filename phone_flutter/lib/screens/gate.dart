...
/// Phone-local gate: PIN entry + fingerprint. Nothing secret leaves the phone.
...
class _GateScreenState extends State<GateScreen> {
  ...
  Future<void> _find() async {
    final found = <String, String>{}; // ip -> pc name
    try {
      ...
      _msg('WiFi scan blocked on this phone — type IP by hand');
      return;
    }
    if (!mounted) return;
    if (found.isEmpty) {
